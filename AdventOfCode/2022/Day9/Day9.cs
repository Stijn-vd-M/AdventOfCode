namespace Day9
{
	public class Day9
	{
		...
		public void Test1()
		{
			...
			var head = new Knot(tail, 0, 0);

			var instructions = Text.Split(LineBreak);

			foreach(var instruction in instructions)
			{
				var split = instruction.Split(Space);
			...
			var result = tail.History.Distinct().Count();
		}
		...
		{
			var tail = new Knot(0, 0);
			var _1 = new Knot(tail, 0, 0);
			var _2 = new Knot(_1, 0, 0);
			var _3 = new Knot(_2, 0, 0);
			var _4 = new Knot(_3, 0, 0);
			var _5 = new Knot(_4, 0, 0);
			var _6 = new Knot(_5, 0, 0);
			var _7 = new Knot(_6, 0, 0);
			var _8 = new Knot(_7, 0, 0);
			var head = new Knot(_8, 0, 0);
			...
			var result = tail.History.Distinct().Count(); // < 2875
		}
	}
}